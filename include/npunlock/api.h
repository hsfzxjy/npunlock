...
#if defined(NPUNLOCK_BUILDING) || defined(NPUNLOCK_COMMON_BUILDING)
#define NPUNLOCK_COMMON_API NPUNLOCK_EXPORT
#else
#define NPUNLOCK_COMMON_API NPUNLOCK_IMPORT
#endif

#if defined(NPUNLOCK_BUILDING) || defined(NPUNLOCK_SHAVECC_BUILDING)
#define NPUNLOCK_SHAVECC_API NPUNLOCK_EXPORT
#else
#define NPUNLOCK_SHAVECC_API NPUNLOCK_IMPORT
#endif

#if defined(NPUNLOCK_BUILDING) || defined(NPUNLOCK_IR2BLOB_BUILDING)
#define NPUNLOCK_IR2BLOB_API NPUNLOCK_EXPORT
#else
#define NPUNLOCK_IR2BLOB_API NPUNLOCK_IMPORT
#endif

#if defined(NPUNLOCK_BUILDING) || defined(NPUNLOCK_PATCHBLOB_BUILDING)
#define NPUNLOCK_PATCHBLOB_API NPUNLOCK_EXPORT
#else
#define NPUNLOCK_PATCHBLOB_API NPUNLOCK_IMPORT
#endif

#if defined(NPUNLOCK_BUILDING) || defined(NPUNLOCK_GRAPHINFER_BUILDING)
#define NPUNLOCK_GRAPHINFER_API NPUNLOCK_EXPORT
#else
#define NPUNLOCK_GRAPHINFER_API NPUNLOCK_IMPORT
#endif
